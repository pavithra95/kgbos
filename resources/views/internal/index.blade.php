...
<table id="theory" 
    ...
    <thead>
        <tr style="font-size: 8pt;">
            ...
            <th colspan="10" style="border: 1px solid black; padding: 4px;">Components for CIA</th>
        </tr>
        <tr style="font-size: 8pt;">
            <th rowspan="2" style="border: 1px solid black;">CIA</th>
            <th rowspan="2" style="border: 1px solid black;">ESE</th>
            <th colspan="2" style="border: 1px solid black; padding: 4px;">CIA – I</th>
            <th colspan="2" style="border: 1px solid black; padding: 4px;">CIA – II</th>
            <th rowspan="2" style="border: 1px solid black; padding: 4px;">Best of CIA-I & CIA-II</th>
        ...
        <tr style="font-size: 8pt;">
            ...
            <th style="border: 1px solid black; padding: 4px;">Actual</th>
            <th style="border: 1px solid black; padding: 4px;">Weightage</th>
            <!-- Best of CIA-I & II -> no subcolumns -->
            <!-- Model -->
            <th style="border: 1px solid black; padding: 4px;">Actual</th>
            <th style="border: 1px solid black; padding: 4px;">Weightage</th>
...
<table id="InternalTable" style="width: 100%; border: 1px solid black; border-collapse: collapse; font-family: 'Times New Roman', serif; font-size: 8pt; text-align: center; table-layout: fixed;">
    <thead>
        <tr>
            ...
            <th colspan="8" style="border: 1px solid black; padding: 6px;">Components for CIA</th>
        </tr>
        <tr>
            <th colspan="2" style="border: 1px solid black; padding: 4px;">Test - I</th>
            <th colspan="2" style="border: 1px solid black; padding: 4px;">Test - II</th>
            <th colspan="2" style="border: 1px solid black; padding: 4px;">Model</th>
...
<table id="ExamTable" style="width: 100%; border: 1px solid black; border-collapse: collapse; font-family: 'Times New Roman', serif; font-size: 8pt; text-align: center; table-layout: fixed;">
    <thead>
        <tr>
            ...
            <th rowspan="2" style="border: 1px solid black; padding: 6px;">No. of experiments</th>
            <th colspan="3" style="border: 1px solid black; padding: 6px;">Marks</th>
            <th rowspan="2" style="border: 1px solid black; padding: 6px;">Weightage</th>
        </tr>
        <tr>
