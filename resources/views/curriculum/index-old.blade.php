    ...
    <script>
        ...
        function addRow(button) {
            ...
            row.innerHTML = `
                ...
                <input type="checkbox" class="cell-select"/><input type="text" name="courseCode[]"></td>
                <td style="border: 1px solid black; text-align: center;">
                <input type="checkbox" class="cell-select"/><input type="text" name="part[]"></td>
                <td style="border: 1px solid black; text-align: center;">
                <input type="checkbox" class="cell-select"/><input type="text" name="courseCategory[]"></td>
                <td style="border: 1px solid black; text-align: center;">
                <input type="checkbox" class="cell-select"/><input type="text" name="courseName[]"></td>
                <td style="border: 1px solid black; text-align: center;">
                <input type="checkbox" class="cell-select"/><input type="number" name="hrsPerWeek[]"></td>
                <td style="border: 1px solid black; text-align: center;">
                <input type="checkbox" class="cell-select"/><input type="number" name="duration[]"></td>
                <td style="border: 1px solid black; text-align: center;">
                <input type="checkbox" class="cell-select"/><input type="number" name="cia[]"></td>
                <td style="border: 1px solid black; text-align: center;">
                <input type="checkbox" class="cell-select"/><input type="number" name="ese[]"></td>
                <td style="border: 1px solid black; text-align: center;">
                <input type="checkbox" class="cell-select"/><input type="number" name="total[]" readonly></td>
                <td style="border: 1px solid black; text-align: center;">
                <input type="checkbox" class="cell-select"/><input type="number" name="credits[]"></td>
                <td style="border: none">
                <button type="button" class="delete-row delete" onclick="deleteRow(this)">X</button></td>
            `;
            ...
            row.querySelectorAll('input[type="text"]').forEach(input => {
                ...
                row.querySelectorAll('input[type="number"]').forEach(input => {
                    input.addEventListener('change', () => calculateTotals(table));
                });
            }
            ...
            // Process each visible row (skip rows spanned by merged cells)
            for (let i = 0; i < rows.length; i++) {
                const row = rows[i];
                
                // Skip if this row is spanned by a merged cell above it
                const firstCell = row.cells[0];
                if (firstCell && firstCell.hasAttribute('rowspan') && firstCell.rowSpan > 1) {
                    // Skip the next (rowspan-1) rows
                    i += firstCell.rowSpan - 1;
                    continue;
                }

                // Process this row's inputs
            ...
            // Update totals
            table.querySelector('.totalHrs').value = totalHrs;
            table.querySelector('.totalCredits').value = totalCredits;
            table.querySelector('.totalMarks').value = totalMarks;
        }
