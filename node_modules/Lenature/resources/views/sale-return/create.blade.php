    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="m-0 text-dark col-md-6 float-left">Sales Return Bill</h4>
                    </div>
                </div>
                <br>

                <form id="order-form" action="/sale-returns" method="POST" role="form" class="col-md-12" autocomplete="off" @submit.prevent="submitForm">
                    {{ csrf_field() }}
        ...
        new Vue({
            ...
            methods: {
                ...
                fetchOrderDetails: function() {
                    axios.post('/sale-returns/get-order-details', {
                        _token: '{{ csrf_token() }}',
                ...
                checkQuantityLimit: function(index) {
                    const item = this.order_items[index];
                    if (item.quantity >= item.sale_order_qty) {
                    item.quantity = item.sale_order_qty;
                ...
                submitForm: function() {
                    ...
                    if (this.isValidForm()) {
                        ...
                        .then(response => {
                            if (response.data.success) {
                                window.location.href = '/sale-returns';
            } else {
