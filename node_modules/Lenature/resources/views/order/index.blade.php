            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <h1 class="m-0 text-dark col-md-6 float-left">Sale Order Details</h1>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content" style="width:800px">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <p>Customer Mobile:  {{$item->customer->customer_mobile}}</p>
                                               
                                                      
                                                <p>Date:{{$item->invoice_date}}</p>
                                                <p>Order No:{{ $item->invoice_no }}</p>
                                                <hr>
                                                <table>
