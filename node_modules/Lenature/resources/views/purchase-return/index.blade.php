            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <h1 class="m-0 text-dark col-md-6 float-left">Purchase Return Details</h1>

                        <a class="btn btn-primary float-right btn-sm" href="/purchase-returns/create"><i class="fa fa-plus" aria-hidden="true"> New</i> </a>
                    </div>
                </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content" style="width:800px">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <hr>
                                                <form>
                                                 <p>Customer Name:  {{$item->customer->vendor_name}}</p>
                                                
                                                <p>Customer Mobile:  {{$item->customer->vendor_mobile}}</p>
                                               
                                                      
                                                <p>Date:{{$item->purchase_invoice_date}}</p>
                                                <p>Order No:{{ $item->purchase_invoice_no }}</p>
                                                <hr>
                                                <table>
