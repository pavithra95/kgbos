        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="/products/{{$item->id}}" method="POST" role="form" class="col-md-12" autocomplete="off">
                    ...
                    <div class="row">
                    <div class="col-md-6">
                            <div class="form-group @if($errors->has('batch_code')) text-danger @endif">
                                <label for=""> Batch Code</label>
                                <input type="text" name="batch_code" class="form-control" value="{{$item->batch_code}}" required="required">
                                @if($errors->has('name'))
