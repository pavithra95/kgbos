            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <h1 class="m-0 text-dark col-md-6 float-left">Purchase Order Details</h1>

                        <a class="btn btn-primary float-right btn-sm" href="/purchase-orders/create"><i class="fa fa-plus" aria-hidden="true"> New</i> </a>
                    </div>
                </div>
