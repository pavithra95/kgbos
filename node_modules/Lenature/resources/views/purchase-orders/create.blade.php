    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form id="order-form" action="/purchase-orders" method="POST" role="form" class="col-md-12" autocomplete="off" @submit.prevent="submitForm">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('name')) text-danger @endif">
                                ...
                                <input type="text" name="invoice_number" class="form-control" v-model="invoice_number" required="" readonly>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <template v-for="item in order_items">
                                ...
                                <input type="hidden" name="available_qty[]" :value="item.available_qty">
                            </template>
                            <input type="hidden" name="grand_total" :value="grandTotal">

                            <tr v-for="(item, index) in order_items" :key="index">
                                <td style="width: 300px;">
                                    <input :id="'batch_code_' + index" class="form-control" type="text" v-model="item.batch_code" @change="fetchPurchaseProductDetails(index)" @keypress.enter.prevent="handleEnterKey(index)">
                                </td>
                                <td style="width: 300px;">
                                    <input class="form-control" type="text" v-model="item.product_id">
                                </td>
                                <td style="width: 150px;"><input class="form-control" type="number" :min="1" :max="item.available_qty"  v-model="item.quantity" @input="calculateTotal(index)" @keydown.enter.prevent="handleKeyPress(index, $event)"></td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="width:800px">
            <div class="modal-header">
                <h5 class="modal-title" id="invoiceModalLabel">Invoice RECEIPT</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" id="invoiceContent">
                <!-- Invoice content will be injected here by Vue -->
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-success" @click="printInvoice">Print</button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        new Vue({
            ...
            methods: {
                ...
                fetchPurchaseProductDetails: function(index) {
                    const batchCode = this.order_items[index].batch_code;
                    this.isBatchCodeFilled = batchCode.trim() !== '';
                    axios.post('/purchase-orders/get-product-details', {
                            _token: '{{ csrf_token() }}',
                        ...
                        .then(response => {
                            if (response.data.success) {
                                ...
                                if (existingItemIndex !== -1 && existingItemIndex !== index) {
                                    ...
                                    this.order_items[index].available_qty = product.available_qty;
                        ...
                        axios.post('/purchase-orders', {
                            ...
                            .then(response => {
                                if (response.data.success) {
                                    ...
                                    // this.showInvoice(response.data.order); // Show invoice immediately after saving
                                    // this.printInvoice(); // Print the invoice
                                } else {
                ...
                handleEnterKey: function(index) {
                    ...
                    this.fetchPurchaseProductDetails(index);
                },
                ...
                showInvoice: function(order) {
                    ...
                    const invoiceContent = `
                        ...
                        <hr>
                        <p>Customer Name: ${order.vendor_name}</p>
                        <p>Customer Mobile: ${order.vendor_mobile}</p>
